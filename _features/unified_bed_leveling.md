...
{% endalert %}
 ...
 - See also [G26 Mesh Validation](https://marlinfw.org/docs/gcode/G026.html) and [G29 for UBL](https://marlinfw.org/docs/gcode/G029.html).
...
If a [`G28`](/https://marlinfw.org/docs/gcode/G028.html) hasn’t already been done then the [`G28`](https://marlinfw.org/docs/gcode/G028.html) sequence will automatically be done followed by the` G29 P1` probing.
...
Possible workarounds are to keep your finger on the reset button/power switch so you can quickly stop the probe process, or being ready to quickly issue [`M112`](https://marlinfw.org/docs/gcode/M112.html) (emergency stop) if **and only if** you have `EMERGENCY_PARSER` enabled in `Configuration_adv.h`.
